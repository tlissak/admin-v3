...
Loader('client','email')->View(array('id'=>"id",'email'=>"Email",'last_name'=>'Nom','first_name'=>'prénom') )
    ...
    ->FormControl('text','pass','Mot de passe',array('readonly'=>1))
    ...
    ->FormControl('text','phone','Tél')
    ->FormControl('text','cell','Port.')
    ->FormControl('text','fax','Fax')
    ...
    ->FormControl('text','fac_phone','Tél',array('panel'=>'facture'))
    ->FormControl('text','fac_cell','Port.',array('panel'=>'facture'))
    ->FormControl('text','fac_fax','Fax',array('panel'=>'facture'))
