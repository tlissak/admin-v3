...
$base_url = isset($_GET['base']) ? $_GET['base'] :
	// Get HTTP/HTTPS
...
$access_keys = array("7B6YhaP5en6B6lcxD5l3Bg");
...
$fixed_path_from_filemanager            = array('photos/','photos/'); //fixed path of the image folder from the current position on upload folder
