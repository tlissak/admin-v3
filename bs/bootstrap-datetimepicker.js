 ...
 * doc : http://tarruda.github.io/bootstrap-datetimepicker/
 * =========================================================
...
(function($) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function(element, options) {
      ...
      //tlissak format override
      if (this.isInput && this.$element.data('format')) this.format = this.$element.data('format');
      else if(this.$element.find('input').data('format')) this.format = this.$element.find('input').data('format')  ;
      else this.format = options.format;
    ...
    place: function(){
      ...
      var offset = this.component.size() ? this.component.offset() : this.$element.offset();
      this.width = this.component.size() ? this.component.outerWidth() : this.$element.outerWidth();
